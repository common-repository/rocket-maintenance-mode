...
td span#pal {
 ...
 <table class="form-table">
        ...
        <td><label for="mmp_title">
          <input type="text" id="mmp_title"  name="mmp_title" value="<?php echo esc_attr(get_option( 'mmp_title' )); ?>" />
...
<table class="form-table">
        ...
        <td><label for="mmp_headline">
          <input type="text" id="mmp_headline"  name="mmp_headline" value="<?php echo esc_attr(get_option( 'mmp_headline' )); ?>" />
      ...
      <tr valign="top">
        ...
        <td><label for="mmp_background_image">
          <input id="image_location" type="text" name="mmp_background_image" value="<?php echo esc_url(get_option('mmp_background_image')); ?>" size="50" />
                    <input class="onetarek-upload-button button" type="button" value="Upload Image" />
